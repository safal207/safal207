...
|---|---|---|---|
| **CrewAI — independent evidence reproduction** | An external contributor downloaded two public RESONANCE evidence bundles, matched their published SHA-256 manifests, ran both offline verifiers, and preserved the intended conservative classifications: `OBSERVED_EVENT_ONLY` and `INCOMPLETE_RETRIEVAL / UNCERTAIN`. | [CrewAI #5802 — external comparison](https://github.com/crewAIInc/crewAI/issues/5802#issuecomment-5743395182) · [evidence record](https://github.com/safal207/resonance-arbitrage-graph/blob/main/docs/external-verification-record.md) | Reproducibility of the bounded public evidence; **not** network-completeness or exactly-once proof. |
